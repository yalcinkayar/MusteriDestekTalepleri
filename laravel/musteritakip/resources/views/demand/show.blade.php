    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            @if($data->status == \App\Models\Demand::OPEN)
                <a href="{{route('demand.status',['demandId'=>$data->id,'statusId'=>\App\Models\Demand::CLOSED])}}" class="btn btn-danger mb-2">Talebi Kapat</a>
            @else
                <a href="{{route('demand.status',['demandId'=>$data->id,'statusId'=>\App\Models\Demand::OPEN])}}" class="btn btn-success mb-2">Talebi Aç</a>
            @endif
            <div class="card">
            ...
            <div class="card mt-2">
                ...
                <form action="{{route('demand.store')}}" method="POST">
                    ...
                    <textarea name="text" id="" cols="30" rows="5" class="form-control mb-2"></textarea>
